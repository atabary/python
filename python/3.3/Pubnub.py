...
class Pubnub():
    ...
    def __init__(self, publish_key, subscribe_key, secret_key=False,
                 ssl_on=False, origin='pubsub.pubnub.com', pres_uuid=None):
        """
        #**
        #* Pubnub
        #*
        ...
        #* @param string pres_uuid optional identifier for presence
        ...
        self.uuid = pres_uuid if pres_uuid else str(uuid.uuid4())
    ...
    def subscribe(self, args):
        ...
        subscribe_key = args.get('subscribe_key', self.subscribe_key)
    ...
    def _request(self, request, origin=None, encode=True, params=None):
        ...
        try:
            try:
                usock = urllib.request(url, None, 200)
            except TypeError:
                usock = urllib.request(url, None)
            response = usock.read()
            usock.close()
